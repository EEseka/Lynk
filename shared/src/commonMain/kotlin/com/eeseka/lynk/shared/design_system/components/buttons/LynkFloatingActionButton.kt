...
import com.slapps.cupertino.CupertinoPickerIndicator
    ...
    if (isIOS()) {
        CupertinoButton(
            ...
            colors = CupertinoButtonDefaults.filledButtonColors(
                ...
                disabledContainerColor = LynkTheme.colors.textMain.copy(alpha = 0.12f),
        ...
        FloatingActionButton(
            ...
            modifier = modifier,
            shape = CircleShape,
            containerColor = if (enabled) LynkTheme.colors.primary else LynkTheme.colors.textMain.copy(
                alpha = 0.12f
            ),
            contentColor = if (enabled) Color.White else LynkTheme.colors.textMain.copy(alpha = 0.38f),

...
interface HangoutService {
    ...
    /**
     * Fetches the user's upcoming hangouts to populate the "Hangouts" tab feed.
     */
    suspend fun getUpcomingHangouts(): Result<List<Hangout>, DataError.Remote>

    /**
     * Host cancels the hangout completely.
     */
